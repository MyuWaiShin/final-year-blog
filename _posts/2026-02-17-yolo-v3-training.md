...
<p style="font-size:0.85rem; color:#888;"><em>The textured mat used can be viewed here: <a href="{{ '/assets/files/Texture Mat.pdf' | relative_url }}">Texture Mat (PDF)</a></em></p>
