...
<div style="display:flex; justify-content:center; gap:2rem; flex-wrap:wrap; margin-bottom:0.5rem;">
  <figure style="display:flex; flex-direction:column; align-items:center; flex:1; min-width:280px; max-width:45%;">
    <img src="/assets/img/raw_detection_3.png" alt="AABB failing on rotated objects" style="display:block; float:none; width:100%; aspect-ratio: 4/3; object-fit: cover; border-radius: 4px;" />
  ...
  <figure style="display:flex; flex-direction:column; align-items:center; flex:1; min-width:280px; max-width:45%;">
    <img src="/assets/img/HBB_cube.png" alt="AABB on a cylinder" style="display:block; float:none; width:100%; aspect-ratio: 4/3; object-fit: cover; border-radius: 4px;" />
    <figcaption style="font-size:0.85rem; color:#666; margin-top:0.4rem; text-align:center;"><em>AABB bounding box for cylinder</em></figcaption>
  </figure>
</div>
