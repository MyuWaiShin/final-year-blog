...
<div style="text-align:center; margin:1.5rem 0;">
  <img src="/assets/img/classifier_confusion_matrix.png" alt="Classifier Confusion Matrix" style="width:80%; border-radius:6px; display:block; margin:0 auto;">
  <p style="font-size:0.82rem; color:#888; margin-top:0.35rem;"><em>Confusion matrix (n = 50)</em></p>
</div>

<div style="text-align:center; margin:1.5rem 0;">
  <img src="/assets/img/tcp_height_vs_accuracy.png" alt="TCP Height vs Accuracy" style="width:80%; border-radius:6px; display:block; margin:0 auto;">
...
<div style="text-align:center; margin:1.5rem 0;">
  <img src="/assets/img/fig_navigation (2).png" alt="Navigation Workspace" style="width:80%; border-radius:6px; display:block; margin:0 auto;">
...
<div style="text-align:center; margin:1.5rem 0;">
  <img src="/assets/img/fig_recovery.png" alt="Recovery Workspace" style="width:80%; border-radius:6px; display:block; margin:0 auto;">
